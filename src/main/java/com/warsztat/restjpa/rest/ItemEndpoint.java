...
public class ItemEndpoint
{
   ...
   {
      TypedQuery<Item> findByIdQuery = em.createQuery("SELECT DISTINCT i FROM Item i LEFT JOIN FETCH i.action WHERE i.id = :entityId ORDER BY i.id", Item.class);
   ...
   {
      TypedQuery<Item> findAllQuery = em.createQuery("SELECT DISTINCT i FROM Item i LEFT JOIN FETCH i.action ORDER BY i.id", Item.class);
